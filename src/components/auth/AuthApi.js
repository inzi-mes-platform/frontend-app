import { createRestTemplate, updateAccessToken, registerSecurityErrorHandler } from 'inzi-mes-platform-frontend-framework';
...
import { Queue } from 'inzi-mes-platform-frontend-framework';
