          ...
          <AnimateButton>
            ...
            >
              <Box sx={{ mr: { xs: 1, sm: 2, width: 20 } }}>
                {/* <img src={Google} alt="" width={16} height={16} style={{ marginRight: matchDownSM ? 8 : 16 }} /> */}
      ...
      >
        {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
          <form noValidate onSubmit={handleSubmit} {...others}>
            ...
            <FormControl fullWidth error={Boolean(touched.password && errors.password)} sx={{ mt: 2, ...theme.typography.customInput }}>
